...
const SvgSuccessFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#success-filled_svg__a)'>
      <path
        fill='#1FA45C'
        fillRule='evenodd'
    ...
    <defs>
      <clipPath id='success-filled_svg__a'>
        <path fill='#fff' d='M0 0h24v24H0z' />
      </clipPath>
    </defs>
  </svg>
);
export { SvgSuccessFilled as SvgComponent };
