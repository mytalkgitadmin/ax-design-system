...
const SvgNegativeDuo = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#negative-duo_svg__a)'>
      <path
        fill='#FFEEF1'
    ...
    <defs>
      <clipPath id='negative-duo_svg__a'>
        <path fill='#fff' d='M0 0h24v24H0z' />
      </clipPath>
    </defs>
  </svg>
);
export { SvgNegativeDuo as SvgComponent };
