...
const SvgSuccessDuotone = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#success-duotone_svg__a)'>
      <path
        fill='#F1FCF4'
    ...
    <defs>
      <clipPath id='success-duotone_svg__a'>
        <path fill='#fff' d='M0 0h24v24H0z' />
      </clipPath>
    </defs>
  </svg>
);
export { SvgSuccessDuotone as SvgComponent };
