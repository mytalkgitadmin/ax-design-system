...
const SvgKakaoTalkWhite = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#KakaoTalkWhite_svg__a)'>
      <path
        fill='#fff'
        fillRule='evenodd'
    ...
    <defs>
      <clipPath id='KakaoTalkWhite_svg__a'>
        <path fill='#fff' d='M0 0h20v20H0z' />
      </clipPath>
    </defs>
  </svg>
);
export { SvgKakaoTalkWhite as SvgComponent };
